      ...
      steps {
        container('jetty-build') {
          ...
          withEnv(["JAVA_HOME=${tool "$JDKBUILD"}", "PATH=${tool "$JDKBUILD"}/bin:${env.PATH}"]) {
            ...
            sh "cd jetty-home/target/jetty-base && java -jar ../jetty-home/start.jar --approve-all-licenses --create-startd --add-module=resources,server,http,https,http2c,$EEX-webapp,$EEX-deploy,$EEX-servlet,$EEX-security,$EEX-jsp,ssl,logging-log4j2"
